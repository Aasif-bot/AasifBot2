...
module.exports.handleEvent = async ({
	...
	["bot lodu", "bot gandu", "kutta", "Kutta", "GANDU BOT", "BOT GANDU", "BSDK BOT", "bsdk bot", "BOT BSDK", "Bhosdi ke bot", "bhosdika bot", "bot lol", "stupid bot lol", "Chutiya", "chutiya bot", "fuck bot", "gwr bot", "fake bot", "gawar bot", "GAWAR BOT", "CHUTIYA BOT", "TERI MAA KI CHUT", "Gandu bot", "RANDI KA", "CHUTIYA BOT", "bot jhatu", "Gawar Bot", "LADU BOT", "JHATU BOT", "Kutta bot", "bot kutta", "bot bc", "BOT KI MAA KI CHUT", "mc bot", "madrchod bot", "Gandu", "lol bot", "hijda bot", "chtya bot", "bot chutiya", "bc bot", "mc bot", "pagal bot", "PAGAL BOT", "MC BOT", "BC BOT", "Sale", "Bot Gandu", "bot fake", "LOL BOT", "BSDK", "bsdk", "Randi ka"].forEach((a => {
